...
const serverConfig = {
    ...
    resolve: {
        ...
        modules: [
            PATH_SOURCE,
            path.resolve(rootCwd, './node_modules')
        ],
        alias: {
            routes: path.resolve(rootCwd, 'src/routes'),
            config: path.resolve(rootCwd, 'src/config'),
            common: path.resolve(rootCwd, 'src/common'),
            resources: path.resolve(rootCwd, 'resources'),
        }
    },
    module: {
        rules: [
